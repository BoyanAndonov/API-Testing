...
namespace RestSharpServices
{
    public class GitHubApiClient
    {
        ...
        public Issue? GetIssueByNumber(string owner, string repo, int issueNumber)
        {
        ...
        {
            var request = new RestRequest($"{repo}/issues/{issueNumber}/coments");
            var response = client.Execute(request, Method.Get);
        ...
        public Comment? GetCommentById(string repo, int commentId)
        {
            ...
            var response = client.Execute(request);
            return response.Content != null ? JsonSerializer.Deserialize<Comment>(response.Content)
            : null;
        }
        ...
        public object GetIssueByNumber(string repo, int issueNumber)
        {
            throw new NotImplementedException();
        }

        public static implicit operator GitHubApiClient(RestClient v)
        {
            throw new NotImplementedException();
        }
    }
